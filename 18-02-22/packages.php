...
{
 // echo $p;
  $tax_query[]=['taxonomy' => 'packages', 'field' => 'slug','terms' =>array($p)];
  //var_dump($tax_query);
}
if (!empty($d)) 
{
  $tax_query[]=['taxonomy' => 'destination','field' => 'slug','terms' =>$d];
}
if (!empty($pp)) 
{
  $tax_query[]=['taxonomy' => 'pprice','field' => 'slug','terms' =>$pp];
}
if (!empty($s)) 
{
  $tax_query[]=['taxonomy' => 'sstar','field' => 'slug','terms' =>$s];
}
if (!empty($in)) 
{
  $tax_query[]=['taxonomy' => 'inclusions','field' => 'slug','terms' =>$in];
}
