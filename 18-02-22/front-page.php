                ...
                <div class="row">
                    <div class="col-lg-6 bannner_contain_area">
                        <div class="banner_contain wow fadeInLeft" data-wow-duration="3s" data-wow-delay=".1s">
                            ...
                            <p>From Anywhere to all over the World</p>
                        </div>
                    </div>
                        ...
                        <div class="banner_image">
                            <div class="row row-7">
                                ...
                                <div class="col-lg-7 col-md-7 col-7">
                                    <div class="row">
                                        <div class="col-lg-10 col-md-10 col-10 offset-2">
                                            <div class="banner_img_box banner_img_1"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img1.jpg" /></div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <div class="banner_img_box banner_img_2"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img2.jpg" /></div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <div class="banner_img_box banner_img_2"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img3.jpg" /></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5 col-md-5 col-5">
                                    <div class="row row-7">
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <div class="banner_img_box banner_img_3"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img4.jpg" /></div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <div class="banner_img_box banner_img_3"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img5.jpg" /></div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="banner_img_box banner_img_4"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img6.jpg" /></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5 col-md-5 col-5 pl-0">
                                    <div class="banner_img_box banner_img_5"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img7.jpg" /></div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="banner_img_box banner_img_5"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img8.jpg" /></div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-3">
                                    <div class="banner_img_box banner_img_5"><img src="<?php echo get_template_directory_uri(); ?>/images/banner-img9.jpg" /></div>
                                </div>
...
if( $kerala_packages_list ): ?>
    ...
    <!-------- explore area start --------->
    <section class="explore_area" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/explore-bg.jpg);">
        <div class="container">
            
            <div class="d-flex justify-content-end">
                <div class="explore_box wow fadeInRight" data-wow-duration="3s" data-wow-delay=".1s">
                    <h3>Looking to <br/>Explore Something Specific?</h3>
