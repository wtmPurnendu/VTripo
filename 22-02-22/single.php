...
<input type="hidden" name="" id="hh" value="">
            ...
            <div>
              <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="btn btn-custom">Customise & Book</a>
            </div>

            <p>Minimum 10 persons</p>
            <div>
              <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="btn btn-custom">Group offer price</a>
            </div>
            </div>
