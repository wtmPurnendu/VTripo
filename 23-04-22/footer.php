    ...
    <footer class="footer_area">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="footer footer_sape">
                                <div class="footer_logo"><img src="<?php echo get_field('footer_logo','option'); ?>" align="logo" title="" /></div>
            ...
            <div class="text-center">
				<p>Powered by  <a href="https://www.webtechnomind.com/" target="_blank">Webtechnomind IT Solutions.</a></p>
