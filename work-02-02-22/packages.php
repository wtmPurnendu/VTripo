...
<section class="listing_area">
  <div class="container">
    <div class="row">
                      ...
                      <ul>
                        <li>
                          <div class="form-group">
                            ...
                            <label for="check1">Domestic</label>
                          </div>
                        </li>
                        <li>
                          <div class="form-group">
      ...
      <?php 
	$args = array( 'post_type' => 'tourist','orderby' => 'ID', 'order' => 'ASC','posts_per_page' => -1 );
              ...
              <div class="media"> 
                ...
                <div class="media-body"> <a href="<?php the_permalink(); ?>" class="link"><?php echo $title;?></a>
                  ...
                  <?php $ps=1; while( have_rows('hotel_stars') ): the_row(); 
                    ...
                    ?>
<li>
    <input type="radio" onclick="check('<?php echo $star_price;?>')" id="radio-<?php echo $ps; ?>" name="selector" value="<?php echo $star_price;?>">
    ...
    <li> <?php echo $facility_texts;?> :
        ...
        <input type="checkbox" name="one_check" class="one_check" id="checkbox-<?php echo $pps;?>" value="<?php echo $facility_prices;?>"/>
...
<h3><i class="fas fa-rupee-sign"></i> <div id="answer"><?php echo get_field('tprice'); ?></div>  /-</h3>
